...
import {Credentials, LogUserResponse, PreAuthResponse} from '../../index';
...
export const logUser = (
	...
	axios
		...
		.then(response => {
			...
			if(body.includes("Sign in to Xbox") && responseUrl === preAuthResponse.matches.urlPost){
			...
			if(body.includes("Help us protect your account")){
				throw errors.unauthorized("2FA enabled or requires verification");
			}
